...
from .redaction import redact_messages as _redact_messages

# NOTE: ``redact_text`` is available via ``src.redaction`` directly.
...
# Patterns that may indicate sensitive content in messages (for warnings)
