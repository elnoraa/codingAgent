...
class Repl:
    ...
    def _handle_scaffold(self, args: str) -> None:
        """Handle /scaffold commands."""
        from .scaffold import list_templates, scaffold_project, show_template
    ...
    def _handle_command(self, cmd: str) -> None:
        ...
        match parts[0]:
            ...
            case "/scaffold":
                self._handle_scaffold(cmd.split(maxsplit=1)[1] if len(cmd.split(maxsplit=1)) > 1 else "")
            case "/task":
